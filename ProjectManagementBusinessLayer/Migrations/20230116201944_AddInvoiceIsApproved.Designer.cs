...
namespace ProjectManagementBusinessLayer.Migrations
{
    ...
    [Migration("20230116201944_AddInvoiceIsApproved")]
    partial class AddInvoiceIsApproved
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagementBusinessLayer.Entities.ProjectDirector", b =>
                {
                    b.HasBaseType("ProjectManagementBusinessLayer.Entities.Person");

                    b.HasDiscriminator().HasValue("ProjectDirector");
                });
            ...
            modelBuilder.Entity("ProjectManagementBusinessLayer.Entities.Project", b =>
                {
                    ...
                    b.HasOne("ProjectManagementBusinessLayer.Entities.ProjectDirector", null)
                        .WithMany("Projects")
